...
export const Profile_Edit = ({
    ...
    const [tempShortDescription, setTempShortDescription] = useState(shortDescription);
    ...
    const handleProfileChange = async () => {
        setPhone(tempPhone);
        setBio(tempBio);
        setShortDescription(tempShortDescription);
        setSkill(tempSkill);
        setSocialMedia({
        ...
        try {
            const response = await axios.put('API ENDPOINT', profile);
    ...
    return (
        ...
        <div className="login_container">
            <div className="middle">          
                ...
                <button className="signin" onClick={handleProfileChange}>Change Profile</button>
